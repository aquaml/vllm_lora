...
class ModelRunner:
    ...
    def load_model(self) -> None:
        ...
        if self.lora_config:
            ...
            if self.lora_config.use_aqua:
                for lora_request in self.lora_config.lora_requests_supported:
                    logger.info("Storing Lora: {}".format(lora_request.lora_name))
                    self.lora_manager._store_lora(lora_request)
    ...
    def capture_model(self, kv_caches: List[KVCache]) -> None:
        ...
        should_warm = True
        if len(self.graph_runners.keys()) > 0:
