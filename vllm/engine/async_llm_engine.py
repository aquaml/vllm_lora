...
class _AsyncLLMEngine(LLMEngine):
    ...
    async def step_async(self) -> List[RequestOutput]:
        ...
        if self.lora_config and self.lora_config.use_aqua:
            logger.info("Calling responsive.respond()")
            aqua.responsive_manager.respond()
        
        elif self.cache_config.use_aqua_to_provide_memory and (not scheduler_outputs.prompt_run):
            self.inform_aqua(seq_group_metadata_list, scheduler_outputs.scheduled_seq_groups)
...
class AsyncLLMEngine:
    ...
    def from_engine_args(cls,
                         ...
                         start_engine_loop: bool = True, 
                         lora_requests_supported: List[LoRARequest] = None,
                         use_aqua=False) -> "AsyncLLMEngine":
        """Creates an async LLM engine from the engine arguments."""
        # Create the engine configs.
        engine_configs = engine_args.create_engine_configs(lora_requests_supported=lora_requests_supported, use_aqua=use_aqua)
